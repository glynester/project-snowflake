Meteor.methods({
  ...
  'updateProjectVolunteers'(id, currentUserId, currentUserEmail, project, volunteers){
    Projects.update({_id: id}, {$push: {volunteers: currentUserId, volunteersEmail: currentUserEmail}});
    Meteor.call('setProjectStatus', project, volunteers);
  },
  'removeUserFromProject'(id, currentUserId, currentUserEmail, project, volunteers){
    Projects.update({_id: id}, {$pull: {volunteers: currentUserId, volunteersEmail: currentUserEmail}});
    Meteor.call('setProjectStatus', project, volunteers);
